...
def densenet1(use_softmax=True, rel_path='./'):
    nb_classes = 10
    depth = 10
    nb_dense_block = 1
    growth_rate = 12
    ...
    # Create model.
    model = Model(inputs, x, name='CIFAR10_densenet1')
    ...
    # fit 
    model.fit(x_train, y_train, verbose = 1, epochs=5, steps_per_epoch=6)
    model.save('model_densenet1.h5')
    return model
